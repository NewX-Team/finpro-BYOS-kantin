...
public class BaksoUratMending extends javax.swing.JFrame {
    ...
    private static final Color ACCENT = new Color(220, 80, 60);
    private static final Color ACCENT_HOVER = new Color(240, 110, 90);
    ...
    public BaksoUratMending() {
        setTitle("Bakso Urat Mending • Bakso & Mie");
    ...
    private void initComponents() {
        ...
        JLabel titleLabel = new JLabel("Bakso Urat Mending");
        titleLabel.setFont(new Font("Segoe UI", Font.BOLD, 24));
        titleLabel.setForeground(TEXT_WHITE);
        titleLabel.setBounds(0, 68, 400, 35);
        titleLabel.setHorizontalAlignment(SwingConstants.CENTER);

        JLabel subtitleLabel = new JLabel("Bakso & Mie • Indonesian Street Food");
        ...
        viewButton.addActionListener(e -> {
            new read("baksouratmending").setVisible(true);
        });
    ...
    private void placeOrder() {
        ...
        write.write("baksouratmending", nama, makanan, waktu);
    ...
    public static void main(String args[]) {
        ...
        EventQueue.invokeLater(() -> new BaksoUratMending().setVisible(true));
    }
}